...
describe("Better Auth Trusted Origins Configuration", () => {
  ...
  it("does not reject chrome-extension origin with 403 INVALID_ORIGIN", async () => {
  ...
  it("does not reject vercel preview deployment origin with 403 INVALID_ORIGIN", async () => {
    const req = new Request("http://localhost:3000/api/auth/sign-in/email", {
      method: "POST",
      headers: {
        "content-type": "application/json",
